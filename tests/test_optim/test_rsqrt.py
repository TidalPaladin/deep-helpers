...
TEST_CASES: Final = [
    ...
    # Check cooldown with nonzero peak_steps
    (90, 1.0, 10, 10, 100, 10, 0.0, 20, 0.3780),
    (95, 1.0, 10, 10, 100, 10, 0.0, 20, 0.1890),
    (100, 1.0, 10, 10, 100, 10, 0.0, 20, 0.0),
...
TEST_CASES_MOMENTUM: Final = [
    ...
    # Check cooldown with nonzero peak_steps
    (90, 0.85, 10, 10, 100, 10, 0.95, 20, 0.9122),
    (95, 0.85, 10, 10, 100, 10, 0.95, 20, 0.9311),
    (100, 0.85, 10, 10, 100, 10, 0.95, 20, 0.95),
